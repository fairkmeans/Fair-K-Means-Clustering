...
plot(numCenters, costFPCALarr(2,:), '-',  'Color', lightGreen,'LineWidth',b)
plot(numCenters, costFFarr(2,:), '-', 'Color', lightBlue, 'LineWidth',b)
plot(numCenters, costFPCALarr(1,:), '-', 'Color',   darkBlue, 'LineWidth',b)



% legend({['Lloyd (', groupNames{2}, ')'],...
%     'Fair-Lloyd (equal cost)',...
%     ['Lloyd (', groupNames{1}, ')']}, 'FontSize', 30, 'Interpreter', 'latex');
...
saveas(figc, [filename, '_cost33.png']);
