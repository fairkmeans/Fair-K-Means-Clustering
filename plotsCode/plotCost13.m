...
plot(numCenters, costNarr(2,:), '-',  'Color', lightGreen,'LineWidth',b)
%plot(numCenters, costNFarr(2,:), '-', 'Color', lightBlue, 'LineWidth',b)
plot(numCenters, costNarr(1,:), '-', 'Color',  darkBlue , 'LineWidth',b)
...
legend({groupNames{2},groupNames{1}}, 'FontSize', 40, 'Interpreter', 'latex');
